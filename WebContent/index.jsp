...
<html lang="ko">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
          ...
          <div class="hidden md:ml-6 md:flex md:items-center md:space-x-8 nav">
            <a
              href="#dashboard"
              class="text-gray-800 font-bold hover:text-primary px-3 py-2 text-base"
              >시세 정보</a
            >
            <a
              href="#features"
    ...
    <section class="hero-gradient pt-36 pb-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          <div
            class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center scroll-section"
          >
            <div>
              <h1
          ...
          <div
            class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center scroll-section right"
          >
            <div
              class="relative mx-auto w-full border border-solid border-[#ededed] rounded-xl shadow-2xl shadow-[#d0ddf6] overflow-hidden screenshot"
            >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="stat-card bg-white p-6 rounded-lg shadow text-center">
            ...
            <div>
              <h3
                id="count1"
                class="inline-block text-2xl font-bold text-gray-900"
              >
                0
              </h3>
    ...
    <section id="testimonials" class="py-16 bg-primary">
      <div class="max-w-7xl mx-auto px-4 scroll-section sm:px-6 lg:px-8">
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <!-- Testimonial 1 -->
          <div
            class="bg-gray-50 p-6 rounded-lg border border-primary border-opacity-20"
          >
            <div class="flex items-center">
    ...
    <footer class="bg-gray-900 text-gray-400">
      <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="mt-12 border-t border-gray-700 pt-6 flex flex-col md:flex-row md:justify-between items-center">
          <div class="flex space-x-4">
            <!-- 인스타그램도 FA로 -->
            <a href="https://www.instagram.com/grintrader/" target="_blank" class="text-gray-400 duration-100 hover:text-white">
      ...
      <button
      id="back-to-top"
      class="fixed bottom-8 right-8 bg-[#105FFB] text-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition duration-300 opacity-100 visible"
    >
